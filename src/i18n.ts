...
const STRINGS = {
  en: {
    ...
    upTo: 'up to',
    auto: 'Auto-match',
    autoHint: 'The board plays itself — slower than you would. Touch it to take over.',
    free: 'free',
    heatCost: '{n} heat',
    heat: 'Heat {n}',
    heatTo: '{n} to unlock the {size} egg',
    biggerReady: 'Bigger egg unlocked — tap to pick it',
    ...
    coach2: 'Every match sends heat to the nest. Enough heat unlocks a bigger egg — you choose when to switch.',
    ...
    infoStep2: '<b>Heat unlocks bigger eggs.</b> Pick one whenever you like — it is never switched for you. A bigger egg holds bigger dragons, and more cold shells.',
    infoStep3: "<b>Pay to crack it.</b> What hatches pays its multiplier on your crack price. The egg's heat is spent; the rest stays in the nest, and a cold shell gives half of it back. Every crack also adds 5 heat, whatever the price.",
  ...
  zh: {
    ...
    upTo: '最高',
    auto: '自动消除',
    autoHint: '棋盘自己消除——比你亲手玩要慢。随时点棋盘即可接手。',
    free: '免费',
    heatCost: '{n} 热量',
    heat: '热量 {n}',
    heatTo: '再 {n} 解锁{size}蛋',
    biggerReady: '更大的蛋已解锁 — 点击上方选择',
    heatFull: '长老蛋已就绪',
    ...
    coach2: '每次消除都会给龙巢送去热量。热量够了会解锁更大的蛋——换不换由你决定。',
    ...
    infoStep2: '<b>热量解锁更大的蛋。</b>想换的时候自己点选——游戏不会替你切换。蛋越大，能孵出的龙越大，空壳也越多。',
    infoStep3: '<b>付费开蛋。</b>孵出什么，就按它的倍率乘以开蛋价格赔付。开蛋会消耗该档位的热量，剩余热量留在巢里；开出冷壳会返还一半热量。另外每次开蛋固定 +5 热量，与开蛋价格无关。',
    infoTable: '能孵出什么',
    infoEgg: '龙蛋',
