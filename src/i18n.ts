...
const STRINGS = {
  en: {
    ...
    infoStep3: "<b>Pay to crack it.</b> What hatches pays its multiplier on your crack price. The egg's heat is spent; the rest stays in the nest.",
  ...
  zh: {
    ...
    infoStep3: '<b>付费开蛋。</b>孵出什么，就按它的倍率乘以开蛋价格赔付。开蛋会消耗该档位的热量，剩余热量留在巢里。',
    infoTable: '能孵出什么',
    infoEgg: '龙蛋',
